...
\begin{figure}%
	\centering
	\subfloat[Without Histogram Equalization]{{\includegraphics[width=7cm]{no-hist-equ.png}} }%
	\qquad
	\subfloat[With Histogram Equalization]{{\includegraphics[width=7cm]{after-hist-equ.png}} }%
